...
document.getElementById("contact-form").addEventListener("submit", async function(event) {
    ...
    try {
        const response = await fetch("https://portfolio-backend-neon-two.vercel.app/api/contact", { // sends a POST request to the server (your form to the backend using fetch API)
            method: "POST",
